...
#reduce() function is used to reduce the number of values from a list.also take two arguments i.e., a function and a sequence.
...
#question 8
primes_descending = lambda lst: sorted(filter(lambda x: x > 1 and all(x % i != 0 for i in range(2, int(x**0.5) + 1)), lst), reverse=True)
